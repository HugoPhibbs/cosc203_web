...
function App() {
    ...
    function clearHand() {
        ...
        setScore(0)
        /*
         Twoway, since when you update it here, it updates the view directly, updates the view for you

         In this respect, the document and the jsx act as one component, REACTing to changes on either end
         */

    }

    // What is the meaning of card=... where does this come into it?
    return (
        <div className="App">
            <h1>Card Game</h1>
            <p>Score: {score}</p>
